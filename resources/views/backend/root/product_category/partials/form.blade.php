    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="form-modal">Tambah Kategori Produk</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="product-category-form" action="{{ route('admin.product-categories.store') }}" method="POST"
                data-request="ajax" data-success-callback="{{ route('admin.product-categories') }}">
                <div class="modal-body">
                    <div class="alert alert-info mt-1 alert-validation-msg" role="alert">
                        <i class="feather icon-info mr-1 align-middle"></i>
                        <span>Kategori yang telah di tambahkan akan otomatis aktif.</span>
                    </div>
