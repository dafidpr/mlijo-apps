...
@endsection
@section('content')
@if ($productCategory->productSubCategory != null)
<div class="container mb-30">
    <div class="row">
        <div class="col-lg-4-5">
            <div class="shop-product-fillter">
                <div class="totall-product">
                    <p>We found <strong class="text-brand">{{ $productCategory->productSubCategory->product->count() }}</strong> items for you!</p>
                </div>
            ...
            <div class="row product-grid">
                @if($productCategory->productSubCategory != null)
                @foreach ($productCategory->productSubCategory->product as $item)
                    ...
                    <div class="product-cart-wrap mb-30">
                        ...
                        <div class="product-content-wrap">
                            <div class="product-category">
                                <a href="shop-grid-right.html">{{ $productCategory->productSubCategory->product->name }}</a>
                            </div>
                            <h2><a href="shop-product-right.html">{{ strlen($item->name) > 35 ? substr($item->name, 0, 35) . '...' : $item->name }}</a></h2>
