    ...
    <div class="page-header mt-30 mb-50">
        <div class="container">
            <div class="archive-header"
                style="background: url({{ asset('storage/images/banners/header-bg.png') }}) no-repeat center center;">
                ...
                <div class="col-lg-4-5">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p>Kami menemukan <strong
                                    class="text-brand">{{ $productSubCategory->product->count() }}</strong> produk
                                untukmu!</p>
                        </div>
                    ...
                    <div class="row product-grid">
                        @foreach ($productSubCategory->product as $item)
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div>
                                            <span class="font-small text-muted">By <a
                                                    href="vendor-details-1.html">{{ $item->seller->store_name }}</a></span>
                                        </div>
